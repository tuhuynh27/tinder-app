    ...
    <React.Fragment>
      <div className="account-bar">
        <div className="top-section-wrapper">
          ...
          <div className="avatar-wrapper" onClick={() => setIsEdit(true)}>
          ...
          <div className="buttons-section">
            ...
            <div className="button" onClick={() => setIsEdit(true)} style={{ top: 0, width: '56px', height: '56px' }}>
              <svg focusable="false" aria-hidden="true" role="presentation" viewBox="0 0 24 24" width="24px" height="24px"
            ...
            <div className="button" onClick={() => setIsEdit(true)} style={{ background: 'linear-gradient(45deg, #fd267a, #ff6036)' }}>
              <svg focusable="false" aria-hidden="true" role="presentation" viewBox="0 0 24 24" width="24px" height="24px"
                   className="Sq(20px) Sq(16px)--xs">
      ...
      <CSSTransition
        in={isEdit}
        timeout={500}
        classNames="edit-info-anim"
        unmountOnExit
      >
        <EditInfo onClose={() => setIsEdit(false)}/>
      </CSSTransition>
    </React.Fragment>
  )
}
